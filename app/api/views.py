...
class Metrica_de_Mistura: 
    def get_metrica(self, queryset):
        return MetricaCalculator.calcular_metrica(queryset)

class VerdurasViewSet(viewsets.ModelViewSet, Metrica_de_Mistura):
...
class EntregaViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        entrega_info = [{'nome_cliente': entrega.nome_do_cliente, 'endereco': entrega.endereco_da_entrega} for entrega in self.queryset]
